        ...
        <AdvancedPropertyGrid
            items={[
                [
                    ...
                    />,
                    "An optional descriptive name briefly summarizing the goback action. Name appears in the action tree and status output, enhances readibility of the template if specified.",
                    true
                ],
                [
                    "when",
